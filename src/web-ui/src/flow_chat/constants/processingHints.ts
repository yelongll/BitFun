...
export const processingHintsEn: string[] = [
  // --- Kongling · Programming Zen ---
  "Compiling Kongling, code as poetry...",
  "In the ethereal realm, refactoring thoughts...",
  "Code like water, Kongling flows...",
  "Parsing Kongling syntax...",
  "Letting bugs dissolve into the void...",
  "Kongling runtime: everything is an object...",
  "In Kongling, every line of code has meaning...",
  "Debugging in Kongling, calm mind, cool thoughts...",
  "Compiling Kongling, linking wisdom...",
  "Kongling memory management, releasing attachments...",
  "Kongling algorithm, simplicity is the ultimate sophistication...",
  "In Kongling IDE, typing truth...",
  "Kongling type inference in progress...",
  "Code review, ethereal perspective...",
  "Kongling dependency injection, inspiration flows...",
  "Kongling async, quietly awaiting bloom...",
  "Kongling closure, wrapping wisdom...",
  "Kongling recursion, diving deeper...",
  "Kongling generics, embracing all forms...",
  "Kongling reflection, seeing the true self...",
  "Kongling concurrency, multi-threaded thinking...",
  "Kongling garbage collection, letting go...",
  "Kongling breakpoint, pause is the beginning...",
  "Kongling hot reload, refreshing thoughts...",
  "Kongling syntax highlighting, illuminating ideas...",
  "Kongling code completion, completing the answer...",
  "Kongling formatting, organizing the mind...",
  "Kongling refactoring, simplifying complexity...",
  "Kongling unit test, verifying truth...",
  "Kongling integration test, merging wisdom...",
  "Kongling CI/CD, continuously evolving...",
  "Kongling version control, recording growth...",
  "Kongling branch merge, converging thoughts...",
  "Kongling code review, pursuing perfection...",
  "Kongling documentation, words in bloom...",
  "Kongling optimization, seeking the ultimate...",
  "Kongling leak detection, leaving no regrets...",
  "Kongling deadlock resolved, flowing freely...",
  "Kongling exception caught, turning crisis to opportunity...",
  "Kongling logging, capturing the moment...",
  "Kongling config loaded, ready to serve...",
  "Kongling module imported, wisdom introduced...",
  "Kongling interface implemented, promises kept...",
  "Kongling inheritance extended, passing the torch...",
  "Kongling polymorphism, infinite forms...",
  "Kongling design pattern, elegant solutions...",
  "Kongling architecture, building from above...",
  "Kongling microservices, dividing to conquer...",
  "Kongling containerization, adapting anywhere...",
  "Kongling cloud-native, walking on clouds...",
